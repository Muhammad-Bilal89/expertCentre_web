...
//src
import "./MenLaser.scss";

export default function MenLaser() {
    ...
    <div className="laser-men-main">
      ...
      <div className="home-section-4">
        <div className="sec-4-row-1">
          <img className="sec-4-img" src="/homepage/Men/sec-4-img1.png" />
        ...
        <div className="sec-4-row-2">
          <div className="row-2-left">
            <div className="row-2-left-inner">
              ...
              <h2 className="head">We know we are the best</h2>
              <p className="sub-text">
                We don’t just claim it; we prove it too. Ours is a
                state-of-the-art clinic where you will have the luxury of the
                most up-to-date laser devices combined with a treatment
                supervised by the most experienced and highly qualified
                professionals. Another plus point of Expert Centre is that we
                have a friendly and passionate staff, from the receptionist to
                the main aesthetician, who will be at your service from the word
                go. We never compromise on quality and that’s a guarantee.
              </p>

              <BookNowButton />
            </div>
          </div>
          <img className="sec-4-img" src="/homepage/Men/sec-4-img2.png" />
        </div>
      </div>

      <div className="home-section-5">
        <div className="home-section-5-inner">
          <p className="sec-5-head">
            Why Choose Us for Laser Hair Removal Treatment?
          </p>
          <p className="sec-5-sub-head">
            We use the latest medical-grade lasers that give you gold standard
            results while keeping in mind your skin type. We treat all skin
            types safely and effectively. Our top-notch etiquettes and tailored
            treatments are proficient enough to cover and fulfil the
            requirements of our respected clients. Till now, we’ve completed
            over 100,000 Laser Hair Removal treatments successfully with 80-90%
            hair reduction and eradication of ingrown hair. We are the most
            competitively priced clinic and offer the same appointments &
            consultations.
          </p>
      ...
      <div className="homepage-section-6">
        <div className="home-section-6-inner">
          <p className="sec-6-head">
            Results from Mens Laser Hair Removal In London
          </p>
          <p className="sec-6-sub-head">
            You will get a silky soft finish like never before. Below mentioned
            are some of the beneficial results that you are going to get from
            mens laser hair removal treatment.
          </p>
          ...
          <div className="section-6-card-main">
            <div className="sec-6-card">
              ...
              <p className="sec-6-card-text">
                Thick, terminal hair will be gone and new hair coming out will
                be much finer with slow growth.
              </p>
            </div>
            ...
            <div className="sec-6-card center-card">
              ...
              <p className="sec-6-card-text">
                As our Laser Hair Removal treatment works to eradicate the hair
                from the root, you’ll also get rid of irritating ingrown hairs
              </p>
            </div>
            ...
            <div className="sec-6-card">
              ...
              <p className="sec-6-card-text">
                Apart from permanent hair reduction, Expert Centre promises you
                a soft, smooth, silky, hair-free, care-free skin.
              </p>
            </div>
          </div>
